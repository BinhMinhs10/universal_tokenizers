...
class RobertaTokenizer(PreTrainedTokenizer):
    def __init__(
        ...
        self.fairseq_tokens_to_ids = {"<mask>": 3, "<s>": 1, "<pad>": 4, "</s>": 2, "<unk>": 0}
    ...
    @property
    def vocab_size(self):
        return len(self.bpe_dict) + self.fairseq_offset
...
if __name__ == "__main__":
    tokenizer = RobertaTokenizer('data', model_max_length=512)
    print(tokenizer.mask_token_id)
    print(tokenizer.model_max_length)
    text_input = "Chiến thuật đối phó của pháo binh Ukraine với hỏa lực vượt trội từ Nga"
    print(tokenizer.tokenize(text_input))
    text_ids = tokenizer(text_input, return_tensors='pt')
    print(text_ids)